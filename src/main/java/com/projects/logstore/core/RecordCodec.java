...
final class RecordCodec {
    ...
    private static final int BODY_FIXED_BYTES = Long.BYTES + Long.BYTES + Integer.BYTES + Integer.BYTES + Integer.BYTES + Integer.BYTES;
    ...
    static byte[] encode(long offset, long timestamp, String stream, String key, byte[] value) {
        ...
        int crc = crc(offset, timestamp, streamBytes, keyBytes, valueBytes);
    ...
    static Optional<DecodedRecord> decode(ByteBuffer recordBuffer) {
        ...
        int actualCrc = crc(offset, timestamp, streamBytes, keyBytes, valueBytes);
    ...
    static int crc(long offset, long timestamp, byte[] streamBytes, byte[] keyBytes, byte[] valueBytes) {
